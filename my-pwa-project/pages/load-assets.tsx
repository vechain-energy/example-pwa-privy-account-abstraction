	...
	return (
		<AuthenticatedPage>
			<Section>
				...
				<p className='mt-2 text-sm text-gray-300'>
					Your Account Abstraction Wallet is a smart contract that can be instructed to interact on the user's behalf. On the very first action, the contract is deployed.
				</p>
				<p className='mt-2 text-sm text-gray-300'>
